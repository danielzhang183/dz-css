...
<template>
  <Paper>
    ...
    <div v-if="!shot" class="box-description" py-2 flex>
      <div flex @click="init = init % 8 + 1">
        <div text-gray-400>
          init
        </div>
        <div text-gray-500 font-bold px-2>
          {{ init }}
        </div>
      </div>
      <div flex ml-3 @click="len = len % 8 + 1">
        <div text-gray-400>
          len
        </div>
        <div text-gray-500 font-bold px-2>
      ...
      <div flex-auto />
      <div v-if="!stopped" text-gray-400>
        *
      </div>
    </div>
  </Paper>
